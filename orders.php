	...
	<div class="panel-body">
		...
		<form class="form-horizontal" method="POST" action="php_action/createOrder.php" id="createOrderForm">
			  <div class="form-group">
				<label for="clientContact" class="col-sm-2 control-label">Product </label>
				<div class="col-sm-10">
				  <!-- <input type="text" class="form-control" id="clientContact" name="clientContact" placeholder="Contact Number" autocomplete="off" /> -->
				  <select class="form-control" name="productName[]" id="productName" onchange="getProductData(value)" >
			  ...
			  <div class="form-group">
				<label for="batch" class="col-sm-2 control-label">No. of Batchs </label>
				<div class="col-sm-10">
				  <input type="number" min="1" value="1" class="form-control" id="batch" name="batch" placeholder="No. of Batchs"  onchange="changeBatch(this.value)" autocomplete="off" />
			  ...
			  <table class="table" id="productTable">
				<thead>
					<tr>			  			
						...
						<th style="width:15%;">Quantity Using</th>
				...
				<tbody>
				  ...
				  <button type="submit" id="createOrderBtn" data-loading-text="Loading..." data-error-text="Loading..." class="btn btn-success"><i class="glyphicon glyphicon-ok-sign"></i> Save Changes</button>
