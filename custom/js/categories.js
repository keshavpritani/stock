...
$(document).ready(function() {
	...
	$('#addCategoriesModalBtn').unbind('click').bind('click', function() {
		...
		$("#submitCategoriesForm").unbind('submit').bind('submit', function() {
			...
			if(categoriesName == "") {
				$("#categoriesName").after('<p class="text-danger">Material Name field is required</p>');
			...
			if(categoriesStatus == "") {
				$("#categoriesStatus").after('<p class="text-danger">Material Stock field is required</p>');
		...
		$.ajax({
			...
			success:function(response) {
				...
				$("#editCategoriesForm").unbind('submit').bind('submit', function(e) {
					...
					if(categoriesName == "") {
						$("#editCategoriesName").after('<p class="text-danger">This field is required</p>');
					...
					if(categoriesStatus == "") {
						$("#editcategoriesStatus").after('<p class="text-danger">This field is required</p>');
