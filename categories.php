		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="div-action pull pull-right" style="padding-bottom:20px;">
					<button class="btn btn-default button1" data-toggle="modal" id="addCategoriesModalBtn" data-target="#addCategoriesModal"> <i class="glyphicon glyphicon-plus-sign"></i> Add Material </button>
				</div> <!-- /div-action -->				
    	...
    	<form class="form-horizontal" id="submitCategoriesForm" action="php_action/createCategories.php" method="POST">
	      ...
	      <div class="modal-body">
	        ...
	        <div class="form-group">
	        	<label for="categoriesName" class="col-sm-4 control-label">Material Name: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-7">
				      <input type="text" class="form-control" id="categoriesName" placeholder="Material Name" name="categoriesName" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->	         	        
	        <div class="form-group">
	        	<label for="categoriesStatus" class="col-sm-4 control-label">Quantity in Stock: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-7">
				      <input type="number" class="form-control" id="categoriesStatus" placeholder="Material Stock" step="0.01" name="categoriesStatus" min=0 autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->	         	        
	      </div> <!-- /modal-body -->
    	...
    	<form class="form-horizontal" id="editCategoriesForm" action="php_action/editCategories.php" method="POST">
	      ...
	      <div class="modal-body">
		      ...
		      <div class="edit-categories-result">
		      	<div class="form-group">
		        	<label for="editCategoriesName" class="col-sm-4 control-label">Material Name: </label>
		        	<label class="col-sm-1 control-label">: </label>
					    <div class="col-sm-7">
					      <input type="text" class="form-control" id="editCategoriesName" placeholder="Material Name" name="editCategoriesName" autocomplete="off">
					    </div>
		        </div> <!-- /form-group-->	         	        
		        <div class="form-group">
		        	...
		        	<label class="col-sm-1 control-label">: </label>
					    <div class="col-sm-7">
			      			<input type="number" step="0.01" class="form-control" id="editcategoriesStatus" placeholder="Material Stock" name="editcategoriesStatus" autocomplete="off">
					    </div>
		        </div> <!-- /form-group-->	 
		      </div>         	        
		      <!-- /edit brand result -->
